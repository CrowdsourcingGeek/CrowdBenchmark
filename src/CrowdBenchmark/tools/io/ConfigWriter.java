...
public class ConfigWriter {
	...
	private String FeedBacksPart(HashMap<String, String> input) {
		...
		content += "feedbacksDistributor = "
				+ input.get("feedbacksDistributor") + "\n";
		...
		content += "feedbacksPerWorker = " + input.get("feedbacksPerWorker")
				+ "\n";
		content += "feedbackRatioQuestion = "
				+ input.get("feedbackRatioQuestion") + "\n";
		content += "feedbacksPerQuestion = "
				+ input.get("feedbacksPerQuestion") + "\n";
	...
	private String WorkersPart(HashMap<String, String> input) {
		...
		content += "workerDistributor = " + input.get("workerDistributor")
				+ "\n";
		content += "reliabilityThreshold = "
				+ input.get("reliabilityThreshold") + "\n";
		...
		content += "typeOfDistributor = " + input.get("typeOfDistributor")
				+ "\n";
		content += "//TwoCoin\n";
		content += "typeOfDistributorSensitivity = "
				+ input.get("typeOfDistributorSensitivity") + "\n";
		content += "typeOfDistributorSpecificity = "
				+ input.get("typeOfDistributorSpecificity") + "\n";
	...
	private String AlgorithmsPart(HashMap<String, String> input) {
		...
		content += "IterativeLearning_iter = "
				+ input.get("IterativeLearning_iter") + "\n";
		content += "//GLAD\n";
